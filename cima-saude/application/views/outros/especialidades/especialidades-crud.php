                    ...
                    <div class="block">
                        <div class="block-content">
                            ...
                            <div class="block-header" style="margin-left: -20px; color:#bbb">
                                <h3 class="block-title">Nova especialidade</h3>
                                </div>
                                
                            <form action="<?=base_url('c-outros/especialidade/salvar');?>" method="POST" id="especialidade">
                            ...
                            <div class="block-header" style="margin-left: -20px; color:#bbb">
                                <h3 class="block-title">Lista de especialidades</h3>
                            </div>
                        <div class="row">
                                ...
                                <table class="table table-bordered table-striped js-dataTable-full" >
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?=$data['cod_especialidade']?></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="modal" data-target="#atualizarModal" data-whatever='<?=$s;?>'><i class="fa fa-pencil"></i></button>
                                                     ...
                                                     <button class="btn btn-xs btn-default" type="button" data-toggle="modal" data-target="#excluirModal" data-whatever='<?=$s;?>' data-cod="<?=$data['cod_especialidade']?>"><i class="fa fa-times"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php  } ?>
...
<div class="modal fade" id="atualizarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <form method="POST" action="<?=base_url('c-outros/Especialidade/atualizar');?>" id="especialidade_update">
                <div class="modal-content">                        <div class="block block-themed block-transparent remove-margin-b">
                            <div class="block-header bg-primary-dark">
                                ...
                                <h1>
                                <h3 class="block-title">Atualizar Especialidade</h3>
                            </div>
                            <div class="block-content">
                                <div class="form-group">
                                    ...
                                    <input id="cod_especialidade" type="hidden" name="cod_especialidade">
                                </form>                
                            </div>
                        </div>
...
<div class="modal fade" id="excluirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <form method="POST" action="<?=base_url('especialidades/delete');?>">
            <div class="modal-content">
                <div class="modal-body">
                    <p>Deseja realmente excluir o parceiro: <span id="codigo"></span> - <span id="nome"></span>?</p>
                    
                    <input type="hidden" class="form-control" name='cod_especialidade' id="cod_especialidade">
                </div>
                <div class="modal-footer">
...
<script>
         ...
         $('#atualizarModal').on('show.bs.modal', function (event) {
          ...
          var modal = $(this)
          modal.find('#cod_especialidade').val(recipient.cod_especialidade)
         ...
         $('#excluirModal').on('show.bs.modal', function (event) {
          ...
          modal.find('#codigo').text(recipient.cod_especialidade);
        });
