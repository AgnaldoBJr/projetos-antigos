                    ...
                    <div class="row items-push">
                        <div class="col-sm-10">
                            <h1 class="page-heading">
                                Visualizar Proposta <small><?= $proposta['numero'];?></small>
                            </h1>
                        </div>
                         <div class="col-sm-2">

                            <a class="btn btn-default" type="button" style="float: right;" href="<?=base_url('propostas/novoPDF/' . $proposta['cod_proposta'])?>"><i class="fa fa-file-text-o"></i></a>
                            <a href="<?=base_url('propostas/atualizar/' . $proposta['cod_proposta'])?>" class="btn btn-large btn-primary btn-rounded" style="float: right; margin-right: 10px">Editar</a>
                ...
                <div class="content">
                    <div class="block">
                        <div class="block-content">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <strong>Número da proposta: </strong><?= $proposta['numero'];?><br>
                                </div>
                                 <div class="col-md-4">
                                    <strong>Data de Contratação: </strong><?= $proposta['dt_contratacao'];?><br>
                                </div>
                            </div>
                            <br><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                   <strong>Subtotal: </strong><?= $proposta['pag_subtotal'];?>
                                </div>
                                <div class="col-md-3">
                                    <strong>Desconto: </strong><?= $proposta['pag_desconto'];?>
                                </div>
                                <div class="col-md-3">
                                     <strong>Total: </strong><?= $proposta['pag_total'];?>
                                </div>

                            </div>
                            <div class="row">
                                <div class="col-sm-10"><strong>Forma de Pagamento: </strong><?= $proposta['modo'];?><?php if($proposta['pag_texto'] != ''){?>  (<?= $proposta['pag_texto'];?>) <?php } ?></div>
                                ...
                                <div class="row">
                                    <form action="<?=base_url('propostas/contratar');?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?=base_url('propostas/atualizar/' . $proposta['cod_proposta'])?>" type="submit" name="proposta-status" class="btn btn-sm btn-primary" style="float: right; margin-right: 20px; margin-bottom: 20px;" >Atualizar Proposta</a>
                                            
                                            
                                            <a href="<?=base_url('propostas')?>" type="submit" name="proposta-status" class="btn btn-sm btn-info" style="float: right; margin-right: 20px; margin-bottom: 20px; ">Voltar</a>
                                        </div>
                                    </form>
                                </div>                      
                            </div>
