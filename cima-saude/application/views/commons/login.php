            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="block block-themed animated fadeIn" style="margin-top:50px;">
                        <div class="block-header" style="background: #00bcdd"">
                        ...
                        <div class="block-content block-content-full block-content-narrow">
                            ...
                            <form class="js-validation-login form-horizontal push-30-t push-50" action="<?=base_url('acesso/login');?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <button class="btn btn-block btn-primary" style='float: right; background: #00bcdd; border-color: #00bcdd;' type="submit"><i class="si si-login pull-right"></i>Entrar</button>
                                    </div>
                                </div>
                                <?php 
                                    if($error_database){?>
