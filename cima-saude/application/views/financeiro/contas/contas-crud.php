                    ...
                    <div class="block">
                        <div class="block-content">
                            ...
                            <div class="block-header" style="margin-left: -20px; color:#bbb">
                                <h3 class="block-title">Novo conta</h3>
                                </div>
                                
                            <form action="<?=base_url('c-financeiro/contas/salvar');?>" method="POST" id="exame">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="">
                                            <input class="form-control" type="text" name="nome" placeholder="Insira um nome" value="<?= $this->input->post('nome');?>" onkeyup="caps(this)">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <div>
                                            <textarea class="form-control" name="descricao" rows="2" placeholder="Insira alguma descrição para o exame" onkeyup="caps(this)"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="block-header" style="margin-left: -20px; color:#bbb">
                                <h3 class="block-title">Lista de contas</h3>
                            </div>
                        <div class="row">
                                ...
                                <table class="table table-bordered table-striped js-dataTable-full" >
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?=$data['cod_conta']?></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="modal" data-target="#atualizarModal" data-whatever='<?=$s;?>'><i class="fa fa-pencil"></i></button>
                                                     ...
                                                     <button class="btn btn-xs btn-default" type="button" data-toggle="modal" data-target="#excluirModal" data-whatever='<?=$s;?>' data-cod="<?=$data['cod_conta']?>"><i class="fa fa-times"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php  } ?>
...
<div class="modal fade" id="atualizarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <form method="POST" action="<?=base_url('c-financeiro/Contas/atualizar');?>" id="exame_update">
                <div class="modal-content">                        <div class="block block-themed block-transparent remove-margin-b">
                            ...
                            <div class="block-content">
                                <div class="form-group">
                                        <label class="control-label" for="nome">Nome <span class="text-danger">*</span></label>
                                        <div class="">
                                            <input class="form-control" type="text" id="nome" name="nome" placeholder="Insira um nome" onkeyup="caps(this)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="descricao">Descrição</label>
                                        <div>
                                            <textarea class="form-control" name="descricao" rows="2" placeholder="Insira alguma descrição para o exame" id="descricao" onkeyup="caps(this)"></textarea>
                                        </div>
                                    </div>               
                                    <input id="cod_conta" type="hidden" name="cod_conta">
                                </form>                
                            </div>
                        </div>
...
<div class="modal fade" id="excluirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <form method="POST" action="<?=base_url('contas/delete');?>">
            <div class="modal-content">
                <div class="modal-body">
                    <p>Deseja realmente excluir o parceiro: <span id="codigo"></span> - <span id="nome"></span>?</p>
                    
                    <input type="hidden" class="form-control" name='cod_conta' id="cod_conta">
                </div>
                <div class="modal-footer">
...
<script>
         ...
         $('#atualizarModal').on('show.bs.modal', function (event) {
          ...
          var modal = $(this)
          modal.find('#cod_conta').val(recipient.cod_conta)
         ...
         $('#excluirModal').on('show.bs.modal', function (event) {
          ...
          modal.find('#codigo').text(recipient.cod_conta);
        });
