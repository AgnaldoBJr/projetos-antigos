            ...
            <main id="main-container">
                ...
                <div class="content bg-gray-lighter" style="height: 80px">
                    <div class="row items-push">
                        ...
                        <div class="col-sm-2">
                            <a href="contas-a-receber/novo" class="btn btn-large btn-primary btn-rounded" style="float: right;">Novo</a>
                        </div>
                    </div>
                </div>
                <!-- END Page Header -->
                ...
                <div class="content" style="margin-top: -20px" >
                    <!-- Dynamic Table Full -->
                    <div class="block">
                    <form action="<?=base_url('contas-a-receber/relatorios')?>" method="post" id="filtro"  target="_blank">
                            ...
                            <div class="col-sm-1" style="float: right;">
                                ...
                                <div class="row">    
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="">
                                            <select class="form-control" type="text" id="cliente" name="cliente" placeholder="Escolha uma opção...">
                                                <option value=<?php null;?>>Escolha uma opção...</option>
                                                <?php
                                                    if($dataCliente != false)
                                                    if($dataCliente) foreach ($dataCliente as $data){
                                                ?>
                                                    <option value="<?=$data['cod_cliente']?>" <?php if($data['cod_cliente'] == $this->input->post('cliente')) echo "selected";?>><?=$data['nome']?></option>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label class="control-label" for="centro">Centro de Lucro</label>
                                        <div class="">
                                            <select class="form-control" type="text"  name="centro" placeholder="Escolha uma opção...">
                                                ...
                                                ?>
                                                    <option value="<?=$data['cod_centro_de_lucro']?>" <?php if($data['cod_centro_de_lucro'] == $this->input->post('centro')) echo "selected";?>><?=$data['nome']?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="">
                                            <select class="form-control" type="text"  name="categoria" placeholder="Escolha uma opção...">
                                                ...
                                                ?>
                                                    <option value="<?=$data['cod_cat_conta_a_receber']?>" <?php if($data['cod_cat_conta_a_receber'] == $this->input->post('categoria')) echo "selected";?>><?=$data['nome']?></option>
                                                <?php } ?>
                                            </select>
                        ...
                        <div class="col-lg-12">
                                        ...
                                        <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="btn btn-xs btn-default" type="button" href="<?=base_url('contas-a-receber/atualizar/' . $data['cod_conta_a_receber'])?>"><i class="fa fa-pencil"></i></a>

                                                        <button class="btn btn-xs btn-default" type="button" data-toggle="modal" data-target="#excluirModal" data-whatever="<?=$data['cod_conta_a_receber']?>"><i class="fa fa-times"></i></button>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <a class="btn btn-primary" style="float: right; margin-bottom: 20px;" href="<?=base_url('contas-a-receber/novo')?>">Novo</a>
                                </div>
                            </div>
                        </div>
                    </div>
