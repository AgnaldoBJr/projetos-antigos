            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <!--FORMULÁRIO DE NOVA CATEGORIA DE CONTAS A PAGAR
                            ...
                            <form action="<?=base_url('c-financeiro/categoriaContaPagar/inserir');?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label class="control-label" for="categoria-centro-custo">Centro de Custo <span class="text-danger">*</span></label>
                                        <div class="">
                                            <select class="form-control" type="text" id="categoria-centro-custo" name="categoria-centro-custo" placeholder="Escolha uma opção...">
                                                <option value=<?php null;?>>Escolha uma opção...</option>
                                                <?php

                                                    if($dataCentro) foreach ($dataCentro as $data){
                                                ?>
                                                    <option value="<?=$data['cod_centro_de_custo']?>"><?=$data['nome']?></option>

                                                <?php } ?>
                                            </select>
                                            <div class="help-block text-right animated fadeInDown" style="color: #d26a5c"><?=form_error('categoria-centro-custo')?></div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered table-striped js-dataTable-full" >
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?=$data['cod_cat_conta_a_pagar']?></td>
                                            <td class="font-w600"><?=$data['nome']?> </td>
                                            <td class="font-w600"><?=$data['centro_de_custo_nome']?> </td>
...
<div class="modal fade" id="atualizarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <form method="POST" action="<?=base_url('c-financeiro/CategoriaContaPagar/atualizar');?>">
                <div class="modal-content">                        <div class="block block-themed block-transparent remove-margin-b">
                            ...
                            <div class="block-content">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="fk_centro_de_custo">Centro de Custo <span class="text-danger">*</span></label>
                                        <div class="">
                                            <select class="form-control" type="text" id="fk_centro_de_custo" name="fk_centro_de_custo" placeholder="Escolha uma opção...">
                                    ...
                                    <input id="cod_cat_conta_a_pagar" type="hidden" name="cod_cat_conta_a_pagar">
                                </form>                
                            </div>
                        </div>
    ...
    <div class="modal fade" id="excluirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <form method="POST" action="<?=base_url('c-financeiro/CategoriaContaPagar/delete');?>">
                <div class="modal-content">
                    <div class="modal-body">
                        <p>Deseja realmente excluir o registro: <span id="nome"></span> ?</p>
                    
                    <input type="hidden" class="form-control" name='cod_cat_conta_a_pagar' id="cod_cat_conta_a_pagar">
                </div>
                <div class="modal-footer">
...
<script>
         ...
         $('#atualizarModal').on('show.bs.modal', function (event) {
          ...
          var modal = $(this)
          modal.find('#cod_cat_conta_a_pagar').val(recipient.cod_cat_conta_a_pagar)
          modal.find('#nome').val(recipient.nome);
          modal.find('#fk_centro_de_custo').val(recipient.fk_centro_de_custo);
        });
