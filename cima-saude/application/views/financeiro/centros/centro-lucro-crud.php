                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-content">
                            ...
                            <!--FORMULÁRIO DE NOVO CENTRO DE LUCRO
                            Nome*  |  Cadastrar -->
                            <div class="block-header" style="margin-left: -20px; color:#bbb">
                                <h3 class="block-title">Novo Centro de Lucro</h3>
                            </div>
                            <form action="<?=base_url('c-financeiro/centroLucro/inserir');?>" method="POST">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label class="control-label" for="centro-lucro-nome">Nome <span class="text-danger">*</span></label>
                                        <div class="">
                                            <input class="form-control" type="text" id="centro-lucro-nome" name="centro-lucro-nome" placeholder="Insira um nome" value="<?= $this->input->post('centro-lucro-nome');?>">
                                            <div class="help-block text-right animated fadeInDown" style="color: #d26a5c"><?=form_error('centro-lucro-nome')?></div>
                                        </div>
                                    </div>
                            ...
                            <div class="block-header" style="margin-left: -20px; color:#bbb">
                                <h3 class="block-title">Lista de Centros de Lucro</h3>
                            </div>
                        <div class="row">
                                ...
                                <table class="table table-bordered table-striped js-dataTable-full" >
                                   ...
                                   <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?=$data['cod_centro_de_lucro']?></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="modal" data-target="#excluirModal2" data-whatever='<?=$s;?>'><i class="fa fa-times"></i></button>
...
<div class="modal fade" id="atualizarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <form method="POST" action="<?=base_url('c-financeiro/CentroLucro/atualizar');?>">
                <div class="modal-content">                        <div class="block block-themed block-transparent remove-margin-b">
                            <div class="block-header bg-primary-dark">
                                ...
                                <h1>
                                <h3 class="block-title">Atualizar Centro de Lucro</h3>
                            </div>
                            <div class="block-content">
                                <div class="form-group">
                                    ...
                                    <input id="cod_centro_de_lucro" type="hidden" name="cod_centro_de_lucro">
                                </form>                
                            </div>
                        </div>
...
<div class="modal fade" id="excluirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <form method="POST" action="<?=base_url('c-financeiro/CentroLucro/delete');?>">
            <div class="modal-content">
                <div class="modal-body">
                    <p>Deseja realmente excluir o registro: <span id="itemExclusao"></span> </p>
                    <input type="hidden" class="form-control" name='cod_centro_de_lucro'>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="excluirModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <form method="POST" action="<?=base_url('c-financeiro/CentroLucro/delete');?>">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name='cod_centro_de_lucro' id="cod_centro_de_lucro">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                <button type="submit" class="btn btn-primary">Excluir</button>
...
<script>
         ...
         $('#atualizarModal').on('show.bs.modal', function (event) {
          ...
          var modal = $(this)
          modal.find('#cod_centro_de_lucro').val(recipient.cod_centro_de_lucro)
          modal.find('#nome').val(recipient.nome);
        });

        $('#excluirModal2').on('show.bs.modal', function (event) {
          var button = $(event.relatedTarget) // Button that triggered the modal
          var recipient = button.data('whatever') // Extract info from data-* attributes
          // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
          // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
