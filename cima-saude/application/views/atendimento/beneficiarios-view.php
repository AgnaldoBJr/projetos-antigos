                    ...
                    <div class="row items-push">
                        <div class="col-sm-10">
                         ...
                         <div class="col-sm-2">
                            ...
                            <a href="<?=base_url('atendimento/beneficiarios/atualizar/' . $cod . '/' . $tab)?>" class="btn btn-large btn-primary btn-rounded" style="float: right; margin-right: 10px">Editar</a>
                        ...
                        <div class="block-content">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <strong>Data de Nascimento: </strong><?php if($beneficiario['cod'] == '1') {$beneficiario['data_nasc'];}else { echo formata_data_br($beneficiario['data_nasc']);}?><br>
                                </div>
                                <div class="col-md-3">
