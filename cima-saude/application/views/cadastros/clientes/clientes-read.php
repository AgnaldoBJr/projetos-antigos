            ...
            <main id="main-container">
                ...
                <div class="content bg-gray-lighter" style="height: 80px">
                    <div class="row items-push">
                        ...
                        <div class="col-sm-2">
                            <a href="clientes/novo" class="btn btn-large btn-primary btn-rounded" style="float: right;">Novo</a>
                        </div>
                    </div>
                </div>
                <!-- END Page Header -->
                ...
                <div class="content" style="margin-top: -20px" >
                    <!-- Dynamic Table Full -->
                    <div class="block">
                    <form action="<?=base_url('clientes/relatorios')?>" method="post" id="filtro"  target="_blank">
                            ...
                            <div class="col-lg-12">
                                <table class="table table-bordered table-striped js-dataTable-full" >
                                    ...
                                    ?>
                                        ...
                                        <td class="text-center"><?=$data['cod_cliente']?></td>
                                            <td class="font-w600"><?php if($data['cnpj'] == null) echo $data['cpf']; else echo $data['cnpj']?> </td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-xs btn-default" type="button" href="<?=base_url('clientes/atualizar/' . $data['cod_cliente'])?>"><i class="fa fa-pencil"></i></a>
