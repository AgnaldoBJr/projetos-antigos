                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-content">
                            <form action="<?=base_url('c-cadastros/franqueado/alterar');?>" method="POST">
                                <input type="hidden" name="cod_franqueado" value="<?php echo $cod_franqueado?>"/>
                                <div class="row">
...
<div id="pf">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <div class="">
                <input class="form-control" type="text" id="nome" name="nome" placeholder="Insira um nome" value="<?php echo $nome?>">
            </div>
        </div>
        <div class="form-group col-md-3">
            <label class=" control-label" for="rg">RG <span class="text-danger">*</span></label>
            <div class="">
                <input class="form-control" type="text" id="rg" name="rg" placeholder="Ex.: 99.999.999-9" value="<?php echo $rg?>">
            </div>
        </div>
        <div class="form-group col-md-3">
            <label class="control-label" for="cpf">CPF <span class="text-danger">*</span></label>
            <div class="">
                <input class="form-control" type="text" id="cpf" name="cpf" placeholder="Ex.: 999.999.999-99" value="<?php echo $rg?>">
            </div>
        </div>
...
?>
    ...
    <div class="block-header" style="margin-left: -20px; color:#bbb">
        <h3 class="block-title">Unidade Médica</h3>
    </div>
    <div class="row">
        <div class="form-group col-md-6">
            <label class="control-label" for="unidade-medica">Unidade Médica <span class="text-danger">*</span></label>
            <div class="">
                <select class="form-control" type="text" id="unidade-medica" name="unidade-medica" placeholder="Escolha uma opção...">
                    <option value="0">Escolha uma opção...</option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                    <!--<option value="1">Solteiro</option>
                    <option value="2">Casado</option>
                    <option value="3">Viúvo</option>-->
    ...
    <div class="block-header" style="margin-left: -20px; color:#bbb">
        <h3 class="block-title">Dados de Acesso</h3>
    </div>
    <?php   
