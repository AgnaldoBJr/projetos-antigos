                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-content">
                            <form action="<?=base_url('c-cadastros/colaborador/alterar');?>" method="POST">
   ...
   <div id="pf">
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <div class="">
                <input class="form-control" type="text" id="cpf" name="cpf" placeholder="Ex.: 999.999.999-99" value="<?php echo $cpf?>">
            </div>
        </div>
