                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="">
                                            <select class="form-control" type="text" name="status" placeholder="Escolha uma opção...">
                                                ...
                                                <option value="p" <?php if("p" == $this->input->post('status')) echo 'selected';?>>Pendente</option>
                                                <option value="c" <?php if("c" == $this->input->post('status')) echo 'selected';?>>Confirmado</option>
                                                <option value="a" <?php if("a" == $this->input->post('status')) echo 'selected';?>>Atendido</option>
                                                <option value="l" <?php if("l" == $this->input->post('status')) echo 'selected';?>>Não Compareceu</option>
                                                <option value="n" <?php if("n" == $this->input->post('status')) echo 'selected';?>>Cancelado</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
