                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-content">
                            ...
                            <form action="<?=base_url('c-processos/exame/salvar');?>" method="POST" id="exame">
...
<div class="modal fade" id="atualizarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <form method="POST" action="<?=base_url('c-processos/Exame/atualizar');?>" id="exame_update">
...
<div class="modal fade" id="excluirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <form method="POST" action="<?=base_url('exames/delete');?>">
