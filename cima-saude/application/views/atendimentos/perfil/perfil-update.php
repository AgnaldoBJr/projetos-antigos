                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-content">
                            <form action="<?=base_url('atendimento/perfil/alterar');?>" method="POST" id="parceiro">
                                ...
                                <div id="especialidades" <?php if($tipo == 'CLÍNICA' || $tipo == 'LABORATÓRIO') echo 'style="display: none"'?>>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <select class="form-control" type="text" id="especialidade2" name="especialidade2" placeholder="Escolha uma opção...">
                                                    <option value="<?=null;?>">ESCOLHA UMA OPÇÃO...</option>
                                                    <?php

                                                    if($dataEspecialidades) foreach ($dataEspecialidades as $data){
                                                ?>
                                                    <option value="<?=$data['cod_especialidade']?>" <?php if($especialidade[1] == $data['cod_especialidade']) echo 'selected'?>><?=$data['nome']?></option>

                                                <?php } ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <select class="form-control" type="text" id="especialidade3" name="especialidade3" placeholder="Escolha uma opção...">
                                                    <option value="<?=null;?>">ESCOLHA UMA OPÇÃO...</option>
                                                    <?php

                                                    if($dataEspecialidades) foreach ($dataEspecialidades as $data){
                                                ?>
                                                    <option value="<?=$data['cod_especialidade']?>" <?php if($especialidade[2] == $data['cod_especialidade']) echo 'selected'?>><?=$data['nome']?></option>

                                                <?php } ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <select class="form-control" type="text" id="especialidade4" name="especialidade4" placeholder="Escolha uma opção...">
                                                    <option value="<?=null;?>">ESCOLHA UMA OPÇÃO...</option>
                                                    <?php

                                                    if($dataEspecialidades) foreach ($dataEspecialidades as $data){
                                                ?>
                                                    <option value="<?=$data['cod_especialidade']?>" <?php if($especialidade[3] == $data['cod_especialidade']) echo 'selected'?>><?=$data['nome']?></option>
